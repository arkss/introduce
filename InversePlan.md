...
3. **컬렉션**
   ...
   - 다양한 헤어스타일
     ...
     - https://github.com/arkss/introduce/blob/master/img/collection/%EC%BB%AC%EB%A0%89%EC%85%98-%ED%97%A4%EC%96%B4%EC%8A%A4%ED%83%80%EC%9D%BC.jpg
   - 월간 헤어 
     - 월간 헤어에서는 각각 헤어스타일에 대한 개성 넘치는 코멘트를 볼 수 있다.

4. **BGM**

   |                이름                 | <center>BGM 느낌<center>                                     |
   | :---------------------------------: | :----------------------------------------------------------- |
...
5. **유료화**
   ...
   | 특징                                                         |
   | :----------------------------------------------------------- |
   | - 게임 내 수익을 창출할 수 있는 건 광고 하나 뿐이다.         |
   | - 성장과정 화면 옆에, 제작자의 다른 게임을 다운로드 할 수 있는 링크가 있다. |
   | - 유료 결제부분이 없다.                                      |
   | - 광고제거 기능이 없다.                                      |
...
| 여러 엔딩 보기가 어렵다.                  |
| 웃기긴 하지만 동시에 슬프다.              |
| 게임 진행이 빠르다. 가볍게 즐기기 좋았다. |
| 다음 날로 넘어갈 때  BGM이 재밌었다.      |
| 캐릭터가 귀엽다.                          |
| 탈모인들에게 비수를 꽂는다.               |
| 간단 조작으로 진행 할 수 있어서 좋았다.   |
| 감동적인 엔딩이 있어서 좋았다.            |
| 광고창이 플레이 할 때 불편하다.           |
| 게임이 반복적이라 지겹다.                 |
| 인터넷 방송을 보고 따라 했다.             |
